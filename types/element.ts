...
export type StreamElementConfig = Partial<{
...
export const STREAM_ELEMENT_IDENTIFIERS = [
...
export type StreamElementIdentifier = typeof STREAM_ELEMENT_IDENTIFIERS[number]
...
export function isStreamElementIdentifier(
  value: string,
): value is StreamElementIdentifier {
  return ([...STREAM_ELEMENT_IDENTIFIERS] as string[]).includes(value)
}
